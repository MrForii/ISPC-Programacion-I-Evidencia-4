...
if __name__ == '__main__':
    print("============================================================================================")
    print("==============================  EVIDENCIA 4 - PROGRAMACIÓN I  ==============================")
    print("============================================================================================")
    numero_pasillos = int(input("\n🛠️  Ingrese la cantidad de pasillos que tiene el edificio: "))
    carga_maxima = int(input("🛠️  Ingrese la capacidad maxima de la montacarga: "))
    montacarga = Montacarga(numero_pasillos, carga_maxima)
    print("============================================================================================")
    try:
        # Vamos a comprobar el estado inicial del montacarga
        montacarga.__str__()

        # Vamos a encenderlo
        montacarga.encender()

        # Vamos a moverlo hasta el pasillo 8 y cargar la montacarga
        montacarga.mover(8)
        montacarga.cargar_montacarga(50)

        # Cargamos mas peso del permitido para controlar que marque el error
        montacarga.cargar_montacarga(30)

        # Nos movemos a otro pasillo y vamos a cargar el montacarga
        montacarga.mover(3)
        montacarga.cargar_montacarga(30)


        # Vamos a moverlo hasta el pasillo 6 y descargar la montacarga  
        montacarga.mover(6)
        montacarga.descargar_montacarga(70)

        # Apagamos el montacarga 
        montacarga.apagar()

        # Mostramos el estado final del montacarga terminado el test
        print("\n❗❗ Estado final del montacarga: ❗❗\n")
        montacarga.__str__()
